...
# for eval:
# python object_detection/eval.py --pipeline_config_path=faster_rcnn_resnet101_coco.config
#   --checkpoint_dir=train_logs --eval_dir=eval_logs
flags.DEFINE_string('eval_dir', '',
                    'Directory to save evaluation summaries.')
